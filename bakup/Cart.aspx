...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Item_Id" DataSourceID="sql_CartItems">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Picture">
                ...
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" Height="100px" ImageUrl='<%# Bind("ImageURL") %>' Width="100px" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
    ...
    <span style="padding-left:200px">Your total deposit is <strong><span class="auto-style3">$</span></strong></span><asp:Label ID="lblDeposit" runat="server" style="font-size:large;font-weight:bold"></asp:Label>.<br />
    Deposit is refundable. The refund ratio is dependent on how you maintain the furniture your borrowed.<br />
    ...
    <asp:Panel ID="pnlAddress" runat="server" Visible="false">
        ...
        <asp:RadioButtonList ID="rblAddress" runat="server" DataSourceID="sql_Address" CssClass="RadioButtonList" DataTextField="Address" DataValueField="Address_Id"></asp:RadioButtonList>
        <asp:SqlDataSource ID="sql_Address" runat="server" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT Address_Id, Name + ': ' + Address1 + ', ' + Address2 + ', ' + City + ', ' + State + ' ' + Zipcode + '  Email: ' + Email + ',   Phone: ' + Phone AS Address FROM paft_Address where User_Id=@User_Id Order by Address_Id Desc">
            <SelectParameters>
        ...
        <asp:Panel ID="pnlAddAddress" runat="server" Visible="false">
            ...
            <table id="Address" style="width: 95%;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbName" runat="server" Width="150px"></asp:TextBox>*</td>
                </tr>
                <tr>
        ...
        <h3>
            ...
            <asp:Panel ID="pnlPolicy" runat="server" Visible="false">
                <h3>Borrow Policy of Perpetual Amities</h3>
                <ol>
                    <li>Acticle 1</li>
                    <li>Acticle 2</li>
                    <li>Acticle 3</li>

    ...
    <table id="config" style="width: 90%">
        <tr>
            ...
            <td><strong>Products:</strong>
                ...
                <asp:TextBox Text='<%# Bind("ImageURL") %>' runat="server" ID="ImageURLTextBox" ReadOnly="True" />
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="PriceTextBox" ErrorMessage="Price should be an integer between 0 and 999." ForeColor="Red" ValidationExpression="\d{0,3}"></asp:RegularExpressionValidator>
                        <br />
                        <asp:LinkButton runat="server" Text="Update" CommandName="Update" ID="UpdateButton" CausesValidation="True" />&nbsp;<asp:LinkButton runat="server" Text="Cancel" CommandName="Cancel" ID="UpdateCancelButton" CausesValidation="False" />
                    </EditItemTemplate>
                    <InsertItemTemplate>
                ...
                <asp:TextBox Text='<%# Bind("Description") %>' runat="server" ID="DescriptionTextBox" /><br />
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="PriceTextBoxNew" ErrorMessage="Price should be an integer between 0 and 999." ForeColor="Red" ValidationExpression="\d{0,3}"></asp:RegularExpressionValidator>
                        <br />
                        <asp:LinkButton runat="server" Text="Insert" CommandName="Insert" ID="InsertButton" CausesValidation="True" />&nbsp;<asp:LinkButton runat="server" Text="Cancel" CommandName="Cancel" ID="InsertCancelButton" CausesValidation="False" />
                    </InsertItemTemplate>
                    <ItemTemplate>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource runat="server" ID="sql_fv_OrderStatus" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [Status_Id], [Order_Status] FROM [paft_Order_Status]" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [paft_Order_Status] WHERE [Status_Id] = @original_Status_Id AND [Order_Status] = @original_Order_Status" InsertCommand="INSERT INTO [paft_Order_Status] ([Order_Status]) VALUES (@Order_Status)" UpdateCommand="UPDATE [paft_Order_Status] SET [Order_Status] = @Order_Status WHERE [Status_Id] = @original_Status_Id AND [Order_Status] = @original_Order_Status">
                    <DeleteParameters>

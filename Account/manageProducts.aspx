    ...
    <table id="config" style="width: 90%">
        <tr>
            <td>
                ...
                <asp:Label ID="Label2" runat="server" Text="Adding items failed. Duplicate Item Codes detected. Please check and add items again!" ForeColor="Red" Style="font-size: medium; font-weight: 700" Visible="False"></asp:Label>
                &nbsp; 
                <br />
